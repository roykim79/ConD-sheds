...
module.exports = (resolve, rootDir, isEjecting) => {
  ...
  const config = {
    ...
    testMatch: ["**/__tests__/**/*[sS]pec.js?(x)"],
    ...
    transformIgnorePatterns: [
      // need to transform node_modules/construction-designer-core/drawing-editor-react
      '[/\\\\]node_modules[/\\\\](?!construction-designer-core[/\\\\]drawing-editor-react[/\\\\]).+\\.(js|jsx)$',
